<template>
  <div>
    ...
    <van-swipe-cell>
      ...
      <van-cell :style="{background:'rgba(0,0,0,0)',color:'white'}" title='112'>
        <template #default>
          <van-icon size="40" name="play-circle-o" />
          <van-icon size="40" name="pause-circle-o" />
          <van-icon size="40" name="stop-circle-o" />
        </template>
      </van-cell>
      <van-cell :style="{background:'rgba(0,0,0,0)',color:'white'}" title='112'></van-cell>
      <template #right>
