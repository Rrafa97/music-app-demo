<template>
  <div class="main-color">
    ...
    >
    <div v-if="cardShow">
      <van-tabs v-model:active="state.serchactive" swipeable @change="changeCat">
        <van-tab :title="'单曲 '">
...
export default {
  ...
  setup() {
    ...
    const state = reactive({
      ...
      password: "",
      serchactive: 0,
      serchcat: [{ name:'专辑',val: 10 },{ name:'歌手',val: 100,data: null,compt: AlbumListItem},{ name:'歌单',val: 1000 },{ name:'用户',val: 1002 },{ name:'MV',val: 1004 },{ name:'歌词',val: 1006 },{ name:'电台',val: 1009 },{ name:'视频',val: 1014 },{ name:'综合',val: 1018 }]
    });
